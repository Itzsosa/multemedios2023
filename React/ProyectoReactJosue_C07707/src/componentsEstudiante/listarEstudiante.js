            ...
            <form id="formulario" onSubmit={this.enviarDatos}>
              <div className="mb-3">
                ...
                <small id="helpId" className="form-text text-muted">
                  Ingresa la cédula del estudiante
                </small>
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                ></input>
                <small id="helpId" className="form-text text-muted">
                  Ingresa el correo electrónico del estudiante
                </small>
              </div>
              <div className="mb-3">
                ...
                ></input>
                <small id="helpId" className="form-text text-muted">
                  Ingresa el teléfono del estudiante
                </small>
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <small id="helpId" className="form-text text-muted">
                  Selecciona el sexo del estudiante
                </small>
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                ></input>
                <small id="helpId" className="form-text text-muted">
                  Ingresa la nacionalidad del estudiante
                </small>
              </div>
              <div className="mb-3">
                <label htmlFor="idCarreras" className="form-label">
                  Id Carreras
                </label>
                <input
                  type="text"
                ...
                ></input>
                <small id="helpId" className="form-text text-muted">
                  Ingresa el id de carreras del estudiante
                </small>
              </div>
              <div className="mb-3">
                ...
                ></input>
                <small id="helpId" className="form-text text-muted">
                  Ingresa el usuario del estudiante
                </small>
              </div>
            </form>
          </Modal.Body>
